/*====================================================
To use a language simply uncomment the import statement 
and add corresponding entry in AceLanguages array
=====================================================*/
...
/*==================================================================
First item in language array contains the name to show in frontend
Second item corresponds to the import statement of that language
*/
let AceLanguages = [
    'c', 'cpp', 'python', 'java', 'javascript'
]

export default AceLanguages;